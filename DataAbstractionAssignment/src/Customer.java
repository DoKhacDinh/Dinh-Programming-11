...
public class Customer {
    ...
    //              - if savingBalance - amt < 0 but >= -100, prints "You have overdrawn your balance!",
    //                decreases savingBalance by amt (if overdraft rules allow), adds a withdrawal entry to withdraws, and returns 0;
    ...
    public double withdraw(double amt, Date date, String account){
        ...
        if(account.equals(CHECKING)){
            ...
            if((savingBalance-amt)<0 && (savingBalance-amt)>=-100){
                System.out.println("You have overdrawn your balance!");
            }else {
                savingBalance -= amt;
