...
public class Customer {
    ...
    //     - If (checkBalance - amt) < 0 but >= -100, prints "You are overdrawing your balance!", decreases
    ...
    //     - If (savingBalance - amt) < 0 but >= -100, prints "You are overdrawing your balance!", decreases
    ...
    public double withdraw(double amt, Date date, String account){
        ...
        if(account.equals(CHECKING)){
            if((checkBalance - amt)<0 && (checkBalance - amt)>=-100){ // In range of overdraft, allowing transaction to be happening
                System.out.println("You are overdrawing your balance!");
                checkBalance -= amt;
